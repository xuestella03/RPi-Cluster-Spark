error id: file://<WORKSPACE>/tpch-scala/src/main/scala/TpchBenchmark.scala:tpch/TpchBenchmark.getQuery5().
file://<WORKSPACE>/tpch-scala/src/main/scala/TpchBenchmark.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol tpch/TpchBenchmark.getQuery5().
...
object TpchBenchmark {
  ...
  def getQu@@ery5(spark: SparkSession): Unit = {
    spark.sql("""
